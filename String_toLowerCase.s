@	Subroutine String_toLowerCase: This method makes a copy of a string and converts
@		the entire string to lower case.
@
...
cmp_loop:
	...
	cmp r1, #91			@ 'Z' = 90 (1 above for PL)
	bpl	no_match		@ If positive, character is above 'Z'
	add r1, r1, #32		@ Add 32 to character (Offset between cases)
